# Generated by Django 4.2.19 on 2025-02-10 11:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reclamacoes', to=settings.AUTH_USER_MODEL, verbose_name='Usuário')),
            ],
            options={
